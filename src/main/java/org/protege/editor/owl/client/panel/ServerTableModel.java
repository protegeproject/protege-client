...
public class ServerTableModel extends AbstractTableModel {
    ...
    public void loadServerData(Client client, RemoteServerDirectory dir) throws OWLServerException {
        ...
        /*
         * Tim and Jenn decided that for the first release, there shouldn't be
         * any server directories exposed to the user - only a list of ontology
         * documents. Server folder structure will come later.
         */
